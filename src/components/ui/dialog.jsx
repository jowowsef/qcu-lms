  ...
  return (
    <DialogPortal>
      ...
      >
        ...
        {showClose && (
          <DialogPrimitive.Close className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-full text-gray-400 outline-none transition hover:bg-gray-100 hover:text-gray-600">
