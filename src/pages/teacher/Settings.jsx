...
function Settings() {
  ...
  const pendingDepartmentRequest = getPendingRequestForField(account.id, "department")
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-gray-500">
                    Your name is set by the admin. To change your email or department, submit a request below.
                  </p>
                </div>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <FieldChangeRequest
                  ...
                  currentValue={account.department}
                  pendingRequest={pendingDepartmentRequest}
                  onRequested={refreshRequests}
                />
            ...
            <div className="border-b bg-gray-50 px-6 py-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-gray-500">
                    Basic information about your teacher account.
                  </p>
                </div>
